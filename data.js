...
window.GAME_DATABASE = {
  ...
  hacking: {
    ...
    spreadsheet: {
      ...
      rows: {
        "Form_Responses": [
          ["2026/08/30 20:50:18", "s2342098cl@chibatech.ac.jp", "外園胡春", "良い記録だけでなく、批判や反省点などのネガティブな経緯等も客観的に残すべきだと思います。また、保存に関しては大学の資料として残してもらえればいいかなと。資料が活かされるのは再発防止の時やこれから挑戦するときが多いので、客観性を重視したいと個人的には思います", "資料の分別作業, デジタル化(スキャン等)の作業"],
          ["2026/08/30 20:55:49", "s23a1058uw@chibatech.ac.jp", "比嘉俊希", "「もう使わないなら消してもいいのでは」と思うこともありますが、後々検証が必要になるかもしれないので残すのが無難かなと思っています。今後データが増えない保存用であれば、できる限り長持ちする物理媒体にまとめて一括保管しておくのが手っ取り早くていいんじゃないかなって あとはせっかくならみんなの写真とかもどこかに保存して、OBが見れるようにしたら嬉しい", "資料の分別作業, 指定場所までの運搬, デジタル化(スキャン等)の作業"],
          ["2026/08/30 20:59:40", "s2341013qr@chibatech.ac.jp", "七瀬いろは", "保存の精度や何を保存するかも大事ですが、何より誰かが使いやすいデータとして残すのが大事だと思います！フォルダ整理をしっかりするとか、AIを活かして検索しやすくするとか。こういう資料が活かされるケースを調べて、それに合わせてまとまった資料を作るのもいいんじゃないかと思います！全然私やりますよ！", "資料の分別作業"]
        ],
        "フォームの回答 1": [
          ["2026/08/30 20:50:18", "s2342098cl@chibatech.ac.jp", "外園胡春", "良い記録だけでなく、批判や反省点などのネガティブな経緯等も客観的に残すべきだと思います。また、保存に関しては大学の資料として残してもらえればいいかなと。資料が活かされるのは再発防止の時やこれから挑戦するときが多いので、客観性を重視したいと個人的には思います", "資料の分別作業, デジタル化(スキャン等)の作業"],
          ["2026/08/30 20:55:49", "s23a1058uw@chibatech.ac.jp", "比嘉俊希", "「もう使わないなら消してもいいのでは」と思うこともありますが、後々検証が必要になるかもしれないので残すのが無難かなと思っています。今後データが増えない保存用であれば、できる限り長持ちする物理媒体にまとめて一括保管しておくのが手っ取り早くていいんじゃないかなって あとはせっかくならみんなの写真とかもどこかに保存して、OBが見れるようにしたら嬉しい", "資料の分別作業, 指定場所までの運搬, デジタル化(スキャン等)の作業"],
  ...
  adminPresets: [
    { id: "s1_start", stage: "S1", name: "1周目 開始（ゲームスタート）", loop: 1, clockISO: "2026-09-04T09:04:00", alertMsg: "", sound: "boot", forceLock: false, color: "#007aff", desc: "周回=1、時刻=09:04、全端末のロックを解除して探索スタート" },
    { id: "s2_loop", stage: "S2", name: "1→2周目 ループ強制発生", loop: 2, clockISO: "2026-09-04T09:04:00", alertMsg: "【時間ループ発生】\n時空ゲートの変調により、時間が巻き戻されました。", sound: "distortion", forceLock: true, color: "#ff9500", desc: "全画面警告→強制ロック→周回=2へ切り替え（歴史改変発生）" },
    { id: "s3_loop", stage: "S3", name: "2→3周目 世界線崩壊ループ", loop: 3, clockISO: "2026-09-04T09:04:00", alertMsg: "【警告：世界線崩壊】\nタイムパラドックスにより世界線が致命的に歪みました。", sound: "alarm", forceLock: true, color: "#ff3b30", desc: "全画面警告→強制ロック→周回=3へ切り替え（U.Z.W.支配世界）" },

...
window.GAME_DATABASE = {
  ...
  hacking: {
    ...
    spreadsheet: {
      ...
      rows: {
        "Form_Responses": [
          ["2026/08/30 20:45:12", "23a20117@chibakou.ac.jp", "深澤文哉", "記録は事実をありのままに残すことが最善だと考えます。個人の推測や主観を排し、何が起きたのか時系列で検証できるように整理しておく必要があります。また、機密情報が含まれるものについては閲覧権限を適切に設定し、不用意な外部流出を防ぐ仕組みを整えてください。", "資料の分別作業, デジタル化(スキャン等)の作業"],
          ...
          ["2026/08/30 21:05:22", "24b1070@chibakou.ac.jp", "陣内樹", "不要になった物理資料は速やかに廃棄すべきです。特に未検証の実験データや学内規約に抵触する恐れのある文書を無防備に保管し続けるのはセキュリティ上極めて危険です。どうしても残す必要があるコアデータのみ、暗号化した上で隔離ストレージに退避させるのが妥当な判断です。", "指定場所までの運搬"],
          ["2026/08/30 21:12:05", "24e2135@chibakou.ac.jp", "連城観", "観測ログや議事録は、たとえ断片であっても後から重大な意味を持つことがあります。デジタルスキャンを行った上で、日付とタグ付けを厳密に行い、アーカイブとして検索可能な状態にしておくことを推奨します。整理作業が必要であればスキャン業務など手伝えます。", "資料の分別作業, デジタル化(スキャン等)の作業"],
          ["2026/08/30 21:18:40", "25b1150@chibakou.ac.jp", "森野航", "資料の保管にかかる物理スペースのコストやクラウドの維持管理費を考慮すべきです。予算執行の観点からは、直近5年分の重要書類を除き、電子化して原本は廃棄するペーパーレス化を進めるのが最も費用対効果が高いと考えます。", "デジタル化(スキャン等)の作業"]
        ],
        "フォームの回答 1": [
          ["2026/08/30 20:45:12", "23a20117@chibakou.ac.jp", "深澤文哉", "記録は事実をありのままに残すことが最善だと考えます。個人の推測や主観を排し、何が起きたのか時系列で検証できるように整理しておく必要があります。また、機密情報が含まれるものについては閲覧権限を適切に設定し、不用意な外部流出を防ぐ仕組みを整えてください。", "資料の分別作業, デジタル化(スキャン等)の作業"],
          ["2026/08/30 20:50:18", "23e2036@chibakou.ac.jp", "外園胡春", "良い記録だけでなく、批判や反省点などのネガティブな経緯等も客観的に残すべきだと思います。また、保存に関しては大学の資料として残してもらえればいいかなと。資料が活かされるのは再発防止の時やこれから挑戦するときが多いので、客観性を重視したいと個人的には思います", "資料の分別作業, デジタル化(スキャン等)の作業"],

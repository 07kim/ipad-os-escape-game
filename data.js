...
window.GAME_DATABASE = {
  ...
  hacking: {
    ...
    spreadsheet: {
      ...
      headers: {
        "フォームの回答 1": ["タイムスタンプ", "氏名", "所属・学籍番号", "部署業務への理解度・意見"],
      ...
      rows: {
        "フォームの回答 1": [
          ["2126/08/21 16:30:15", "陣内 樹", "J-098（神崎研究室）", "神崎教授の研究室から持ち出された機密データ暗号の解除要請。名簿データおよび実験ログのパスコード照会。"],
          ["2126/08/21 17:15:42", "深澤 文哉", "F-042（執行委員会）", "学友会予算執行状況および役員名簿の緊急照会。ループ発生に伴うシステム復旧スケジュールの確認。"],
          ["2126/08/22 08:50:04", "犬飼 玲", "I-012（学内保安統制局）", "【統制局】2026年跳躍者の所持端末の初期化・回収手続き。U.Z.W.最高管理者プロトコルの執行。"]
        ],
        "名簿データ": [

    ...
    courses: {
      ...
      "c_quantum": {
        ...
        news: [
          ...
          { title: "夏季集中実験室（東金地下ラボ）への立ち入りについて", date: "2026-08-15" }
        ],
        materials: [
          { id: 1, title: "第1回: 量子状態と波動関数の基礎", file: "量子力学_01.pdf", content: "「シュレディンガー方程式の基礎と粒子・波動の二重性について学ぶ。」" },
          { id: 2, title: "第2回: 量子トンネル効果とポテンシャル障壁", file: "量子力学_02.pdf", content: "「エネルギー障壁の透過確率とトンネル効果の実用例。」" },
          { id: 3, title: "第3回: 量子もつれと非局所相関", file: "量子力学_03.pdf", content: "「EPRパラドックスとベルの不等式。量子テレポーテーションの原理。」" },
          { id: 4, title: "第4回: 微小ブラックホールの生成と蒸発", file: "量子力学_04.pdf", content: "「ホーキング放射と極小重力場の量子力学的記述。」" },
          { id: 5, title: "第5回: タキオン励起と時空トンネリング理論", file: "量子力学_05.pdf", content: "「虚数質量粒子の励起による超光速情報伝播モデル。」" },
          { id: 6, title: "第6回: ワームホール幾何学と負のエネルギー", file: "量子力学_06.pdf", content: "「カシミール効果によるエキゾチック物質の安定化手法。」" },
          { id: 7, title: "第7回: 時間跳躍実験の基礎数式", file: "量子力学_07.pdf", content: "「閉じた時間的曲線（CTC）と相対論的時空計量。」" },
          { id: 8, title: "第8回: 因果律保護と世界線収束プロトコル", file: "量子力学_08.pdf", content: "「時間ループの発生要因と確率論的収束境界条件。」" },
          { id: 9, title: "第9回: クロノス粒子の観測データと共振特性", file: "量子力学_09.pdf", content: "「東金観測所におけるタキオン・クロノス共鳴パルススペクトル。」" },
          { id: 10, title: "第10回: ゲートキーパー認証回路の設計", file: "量子力学_10.pdf", content: "「多次元位相ゲートを開閉するための生体認証と高周波回路。」" },
          { id: 11, title: "🌟 第11回: タイムマシン起動・ゲート変調周波数メモ", file: "ゲート変調キーのメモ.txt", content: "「【重要・極秘】時空ゲートを安定起動・閉鎖するための変調周波数は【 119.43 MHz 】である。ゲートキーパーにこの周波数を入力することで、時間の歪みを収束させ、本来の世界線へと脱出できる。」" },
          { id: 12, title: "第12回: 最終調整と復元テスト手順", file: "量子力学_12.pdf", content: "「非常停止プロトコルとフェイルセーフ回路の動作検証。」" },
          { id: 13, title: "第13回: 実験総括とレポート提出", file: "量子力学_13.pdf", content: "「全実験データのまとめ。各自ふりかえりシートを提出すること。」" }
        ]
      },
